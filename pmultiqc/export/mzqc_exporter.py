...
class MzQcExporter:
    ...
    def export_to_file(self, metrics: List[Any], filename: str = "qc_metrics.mzQC") -> str:
        ...
        try:
            ...
            raise IOError(f"Failed writing mzQC payload to disk: {e}")
    ###
    ### SHARED CALCULATION across all 7 pipelines
    ###
    
    def _extract_missed_cleavages(self, data_source: Any, key_name: str = "Missed cleavages") -> Optional[List[Dict[str, Any]]]:
    ...
    def _extract_charge_state_distribution(self, data_source: Any, key_name: str = "Charge") -> Optional[Dict[str, float]]:
