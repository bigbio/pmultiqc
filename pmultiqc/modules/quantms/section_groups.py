...
def add_group_modules(groups_dict):
    ...
    config.report_section_order = {
        "pmultiqc": {"order": 17},
        "experiment_setup": {"order": 16},
        "summary_and_heatmap": {"order": 15},
        "identification_summary": {"order": 14},
        "search_engine_scores": {"order": 13},
        "contaminants": {"order": 12},
        "quantification_analysis": {"order": 11},
        "ms1_analysis": {"order": 10},
        "ms2_and_spectral_stats": {"order": 9},
        "time_and_mass_error_trends": {"order": 8},
        "bigbio-quantms-summary": {"order": 7},
        "nf-core-quantms-methods-description": {"order": 6},
        "methods_description": {"order": 5},
        "bigbio-quantms-methods-description": {"order": 5},
        "software_versions": {"order": 4},
