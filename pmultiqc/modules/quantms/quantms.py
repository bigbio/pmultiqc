...
from .section_groups import create_ordered_group_modules, add_group_modules
...
class QuantMSModule(BaseMultiqcModule):
    ...
    def draw_search_engine(self):
        ...
        if spec_e_bar_html != "":
            ...
            # self.add_section(
            #     name="SpecEvalue Description",
            #     anchor="specEvalue_description",
            #     # description="""
        ...
        if xcorr_bar_html != "":
            ...
            # self.add_section(
            #     name="xcorr Description",
            #     anchor="xcorr_description",
            #     # description="""
            #     # #### xcorr description
            #     # """,
            #     helptext="""
        ...
        if hyper_bar_html != "":
            ...
            # self.add_section(
            #     name="hyperscore Description",
            #     anchor="hyperscore_description",
            #     # description="""
        ...
        # self.add_section(
        #     name="Summary of Posterior Error Probabilities (PEP)",
        #     anchor="summary_of_pep",
