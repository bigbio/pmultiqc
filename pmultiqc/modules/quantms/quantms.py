...
class QuantMSModule(BaseMultiqcModule):
    ...
    def mzid_CalHeatMapScore(self, psm):
        ...
        if "retention_time" not in psm.columns:
            ...
            # mzml
            # elif self.ms_paths:
            #     print("mzid_CalHeatMapScore(): need mzml from ms_paths!")
