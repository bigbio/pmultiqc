...
def draw_potential_contaminants(sub_section, contaminant_percent, report_type):
    draw_config = {
    ...
    if report_type == "maxquant":
        ...
        help_text = """
            A contamination plot derived from the psm.tsv.
            Identify based on whether the 'Protein' column contains 'cont'.
            """
    else:
...
def draw_msms_missed_cleavages(sub_section, missed_cleavages_data, is_maxquant):
    ...
    helptext = """
                ...
                <br>FragPipe: [Number of Missed Cleavages] number of potential enzymatic cleavage sites within the identified sequence.
                """
...
def draw_delta_mass_da_ppm(sub_section, delta_mass, delta_mass_type):
    if delta_mass_type == "Mass Error [Da]":
        ...
        help_text = """
            ...
            <br>FragPipe: [Delta Mass] difference between calibrated observed peptide mass and calculated peptide mass (in Da).
            """
...
def draw_summary_protein_ident_table(
    ...
    if enable_mzid or use_two_columns:
...
def draw_identi_num(
    ...
    ms_runs = cal_num_table_data.get("ms_runs") or {}
    sdrf_samples = cal_num_table_data.get("sdrf_samples") or {}

    if not ms_runs and not sdrf_samples:
        log.warning("Both ms_runs and sdrf_samples are empty or None, skipping draw_identi_num.")
        return
    ...
    add_sub_section(
        ...
        plot=table_html,
        order=3,
        description="This plot shows the final pipeline results.",
        helptext="""
    ...
    add_sub_section(
        ...
        helptext="""
            ...
            * 33% of 'Unmodified'              <br>
            ...
            FragPipe: Extracting information from the 'Assigned Modifications' column in psm.tsv.
...
def draw_ids_rt_count(sub_section, rt_count_data, report_type):
    ...
    if report_type == "maxquant":
        ...
        description_text = "Distribution of retention time, derived from the FragPipe."
        help_text = """
